...
namespace mp
{
	...
	MP_ATTR inline void			MP_CALL init(const mp_init_options* options) noexcept { return mp_init(options); }
	MP_ATTR inline void			MP_CALL init() noexcept { return mp_init_default(); }
	...
	namespace debugger
	{
		MP_ATTR inline void		MP_CALL init(const debug_options* options) noexcept { return mp_debug_init((const mp_debug_options*)options); }
